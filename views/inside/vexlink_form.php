    ...
    <div class="row mt1 mb1">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs text-uppercase mt1" role="tablist">
                <li><a class="color-white" href="<?php echo base_url('inside/exlink'); ?>"><strong>List</strong></a></li>
                    ...
                    <div class="tab-pane active" id="ctab">
                        <div class="row">
                            <div class="col-sm-offset-2 col-sm-7">
                                <a href="http://www.datadigital.co.id/" target="_blank" ><img src="<?php echo base_url('asset/img/link/link.jpg'); ?>" class="img-responsive center-block" alt="PT. DATA MUSTIKA ABADI"></a><br>
                            </div>
                            <div class="col-sm-3">
                                <p><small>min. dimensions 243 x 60  </small></p>
                            </div>
                        </div>
                        
                        <form class="form-horizontal" role="form" method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">URL <span class="small color-alizarin">*)</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control input-sm" id="url" name="url" autocomplete="off" value="<?php echo set_value('url', isset($url) ? $url : ''); ?>">
                                    <?php echo form_error('url', '<div class="popover bottom"><div class="arrow"></div><div class="popover-content text-center"><strong class="text-danger">', '</strong></div></div>'); ?>
                                </div>                                        
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Keterangan </label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control input-sm" id="dsc" name="dsc" autocomplete="off" value="<?php echo set_value('dsc', isset($dsc) ? $dsc : ''); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-inline">
                                        <li>
                                            <label><?php echo!empty($pic) ? '<img src="' . base_url() . 'asset/img/link/' . $pic . '" height="75px">' : ''; ?>                                                 </label>
                                        </li>
                                        <li>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">      
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <a href="<?php echo base_url('inside/exlink'); ?>" class="btn2 bg-clouds btn-sm btn-block shadow" role="button">Batal</a> 
                                        </div>          
                                    </div>
                                </div>
                            </div>
