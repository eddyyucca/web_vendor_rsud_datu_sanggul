    ...
    <div class="row mt1 mb1">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs text-uppercase mt1" role="tablist">
                <li class="active"><a href="<?php echo base_url('inside/promosi'); ?>"><strong>List</strong></a></li>
                <li><a class="color-white" href="<?php echo base_url('inside/promosi/add'); ?>"><strong><?php echo $xxx;?></strong></a></li>
            </ul>
                        ...
                        if (empty($prm)) {
                            ...
                            <div class="table-responsive mt1">
                                <table id="tbl5" class="table table-condensed" width="100%" cellspacing="0">
                                    <thead>
                                        <tr><th>No. Urut</th><th>Gambar</th><th>Publish</th><th></th><th></th></tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($prm as $row) {
                                            ?>
                                            <tr>
                                                <td>
                                                    <?php echo $row->odr; ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('inside/promosi/edit/' . $row->idsys); ?>" class="btn btn-xs btn-warning"> edit <i class="fa fa-pencil"></i></a>
                                                </td>
                                                <td>
                                                    <a href="<?php echo base_url('inside/promosi/delete/' . $row->idsys); ?>" class="btn btn-xs btn-danger" onclick="return confirm('Anda yakin akan menghapus promosi <?php echo $row->idsys; ?> ?')"> delete <i class="fa fa-trash-o"></i></a>                                                    
                                                </td>
                                            </tr>
