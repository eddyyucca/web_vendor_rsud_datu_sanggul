            ...
            <div class="transparentbox bg-white" style="border-radius: 0px;">
                <div class="tab-content pad10">
                    <div class="tab-pane active" id="ctab">
                        <div class="row">
                            <div class="col-sm-9">
                                <img src="<?php echo base_url('asset/img/bnr/ban.jpg'); ?>" class="img-responsive center-block" ><br>
                            </div>
                            <div class="col-sm-3">
                                <p>min. dimensions 1350 x 300 </p>
                            </div>
                        </div>
                        ...
                        <form class="form-horizontal" role="form" method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Deskripsi lain </label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-inline">
                                        <li>
                                            <label><?php echo!empty($pic) ? '<img src="' . base_url() . 'asset/img/bnr/' . $pic . '" height="75px">' : ''; ?>                                                 </label>
                                        </li>
                                        <li>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">      
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <a href="<?php echo base_url('inside/banner'); ?>" class="btn2 bg-clouds btn-sm btn-block shadow" role="button">Batal</a> 
                                        </div>          
                                    </div>
                                </div>
                            </div>
