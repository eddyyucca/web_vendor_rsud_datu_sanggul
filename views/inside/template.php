...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Website Resmi RSUD H. Badaruddin Tanjung">
        <meta name="author" content="PT. Data Mustika Abadi www.datadigital.co.id">
        <meta name="keywords" content="Rumah Sakit, Rumah Sakit Umum Daerah, RSUD H. Badaruddin, Tanjung, Tabalong," />
