    ...
    <div class="row mt1 mb1">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs text-uppercase mt1" role="tablist">
                <li><a class="color-white" href="<?php echo base_url('inside/layanan'); ?>"><strong>List</strong></a></li>
                    ...
                    <div class="tab-pane active" id="ctab">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Nama Layanan <span class="small color-alizarin">*)</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Deskripsi <span class="small color-alizarin">*)</span></label>
                                <div class="col-sm-10">
                                    <textarea id="dsc" name="dsc" class="form-control input-sm" rows="20"><?php echo set_value('dsc', isset($dsc) ? $dsc : ''); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-inline">
                                        <li>
                                            <label><?php echo!empty($pic) ? '<img src="' . base_url() . 'asset/img/lyn/' . $pic . '" width="80px" height="75px">' : ''; ?>                                                 </label>
                                        </li>
                                        <li>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">      
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <a href="<?php echo base_url('inside/layanan'); ?>" class="btn2 bg-clouds btn-sm btn-block shadow" role="button">Batal</a> 
                                        </div>          
                                    </div>
                                </div>
                            </div>
