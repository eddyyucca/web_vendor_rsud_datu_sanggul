    ...
    <div class="row mt1 mb1">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs text-uppercase mt1" role="tablist">
                ...
                <li class="active"><a class="color-white" href="<?php echo base_url('inside/berita/kategori'); ?>"><strong>Kategori</strong></a></li>
            </ul>
            ...
            <div class="transparentbox bg-white" style="border-radius: 0px;">
                <div class="tab-content pad10">
                    <div class="tab-pane active" id="ctab">
                        <a class="btn2 bg-belizehole color-clouds pull-right shadow" href="<?php echo base_url('inside/berita/kategori_add');?>"><i class="fa fa-plus"></i> Tambah Kategori</a>
                        <br><br>
                        <?php
                        ...
                        if (empty($ctg)) {
                            ...
                            <div class="table-responsive mt1">
                                <table id="tbl5" class="table table-condensed" width="100%" cellspacing="0">
                                    <thead>
                                        <tr><th>Kategori</th><th></th><th></th></tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($ctg as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('inside/berita/kategori_edit/' . $row->idsys); ?>" class="btn btn-xs btn-warning"> edit <i class="fa fa-pencil"></i></a>
                                                </td>
                                                <td>
                                                    <a href="<?php echo base_url('inside/berita/kategori_delete/' . $row->idsys); ?>" class="btn btn-xs btn-danger" onclick="return confirm('Anda yakin akan menghapus kategori <?php echo $row->kategori; ?> ?')"> delete <i class="fa fa-trash-o"></i></a>                                                    
                                                </td>
                                            </tr>
                                    <?php }
                                    ?>
