    ...
    <div class="row mt1 mb1">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs text-uppercase mt1" role="tablist">
                <li><a class="color-white" href="<?php echo base_url('inside/pengumuman'); ?>"><strong>List</strong></a></li>
                    ...
                    <div class="tab-pane active" id="ctab">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Judul <span class="small color-alizarin">*)</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="ctn" name="ctn" class="form-control input-sm" rows="5"><?php echo set_value('ctn', isset($ctn) ? $ctn : ''); ?></textarea>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2">Gambar / File Lampiran</label>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-inline">
                                        <li>
                                            <?php
                                            $ext = $pic == '' ? '' : substr($pic, strpos($pic, ".") + 1);
                                            $ispic = array("jpg", "jpeg", "png", "gif");
                                            if (in_array($ext, $ispic)) {
                                                echo '<img src="' . base_url() . 'asset/img/brt/' . $pic . '" width="80px" height="75px"> ';
                                            } else {
                                                echo '<a href="' . base_url('asset/img/brt/' . $pic) . '" target="blank_">' . $pic . '</a>';
                                            }
                                            ?> 
                                            <label>                                                </label>
                                        </li>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">      
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <a href="<?php echo base_url('inside/pengumuman'); ?>" class="btn2 bg-clouds btn-sm btn-block shadow" role="button">Batal</a> 
                                        </div>          
                                    </div>
                                </div>
                            </div>
