    ...
    <div class="row mt1 mb1">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs text-uppercase mt1" role="tablist">
                <li class="active"><a href="<?php echo base_url('inside/quotes'); ?>"><strong>List</strong></a></li>
                <li><a class="color-white" href="<?php echo base_url('inside/quotes/add'); ?>"><strong><?php echo $xxx; ?></strong></a></li>
            </ul>
                        ...
                        if (empty($quo)) {
                            ...
                            <div class="table-responsive mt1">
                                <table id="tbl5" class="table table-condensed" width="100%" cellspacing="0">
                                    <thead>
                                        <tr><th>Running Text</th><th>No. Urut</th><th>Publish</th><th></th><th></th></tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($quo as $row) {
                                            ?>
                                            <tr>
                                                <td>
                                                    <?php echo $row->quotes ; ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('inside/quotes/edit/' . $row->idsys); ?>" class="btn btn-xs btn-warning"> edit <i class="fa fa-pencil"></i></a>
                                                </td>
                                                <td>
                                                    <a href="<?php echo base_url('inside/quotes/delete/' . $row->idsys); ?>" class="btn btn-xs btn-danger" onclick="return confirm('Anda yakin akan menghapus quotes <?php echo $row->quotes; ?> ?')"> delete <i class="fa fa-trash-o"></i></a>                                                    
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
