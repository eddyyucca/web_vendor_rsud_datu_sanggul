<div class="transparentbox" style="background: rgba(44, 62, 80, 0.5);">
    <div class="row mt1 mb1">
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-10">
                    <h4 class="kategori text-right color-white border-clouds"> BE<span>RITA</span></h4>                    
                </div>
                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">      
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <a href="<?php echo base_url('inside/berita/kategori'); ?>" class="btn2 bg-clouds btn-sm btn-block shadow" role="button">Batal</a> 
                                        </div>          
                                    </div>
                                </div>
                            </div>
