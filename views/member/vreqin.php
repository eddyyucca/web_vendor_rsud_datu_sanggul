                                        ...
                                        <form role="form" method="post" action="<?php echo $action; ?>" class="mt1">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    $un = array('name' => 'un', 'id' => 'un', 'value' => set_value('un'), 'autocomplete' => 'off', 'class' => 'form-control input-sm', 'placeholder' => 'No.Rekam Medis');
                                                    echo form_input($un);
                                                    ?>                            
                                                </div>
                                            ...
                                            <div class="form-group">   
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    $pwd = array('name' => 'pwd', 'id' => 'pwd', 'value' => set_value('pwd'), 'autocomplete' => 'off', 'class' => 'form-control input-sm', 'placeholder' => 'Tgl.Lahir');
                                                    echo form_input($pwd);
                                                    ?>
                                                </div>          
                                            ...
                                            <div class="form-actions mb1">  
                                                <button type="submit" name="submit" class="btn2 bg-emerald color-white btn-xs btn-block shadow center-block">DAFTAR <i class="fa fa-sign-in"></i></button> 
                                                <!-- <button type="submit" name="submit" class="btn-xs"> BATAL <i class="fa fa-lock"></i></button> -->
                                            </div>
                                        </form>
                                    </div>
                                </div><hr><br>
