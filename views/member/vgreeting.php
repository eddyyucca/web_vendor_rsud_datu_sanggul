    ...
    <div class="col-sm-12">
        ...
        <div class="alert alert-info mt2 mb1">
            <table class="table table-condensed mt1 mb1">
                <tbody>
                    <tr>
                        <td class="col-sm-3">No. RM</td><td>:</td>
                        <td><?php echo isset($pasien->idpasien) ? $pasien->idpasien : ''; ?></td>
                    </tr>
                    <tr>
                        <td class="col-sm-3">Nama</td><td>:</td>
                        <td>
                            <?php echo isset($pasien->nama) ? $pasien->nama : ''; ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="col-sm-3">Alamat</td><td>:</td>
                        <td>
                            <?php
                    ...
                    <tr>
                        <td class="col-sm-3">Jenis Kelamin</td><td>:</td>
                        <td><?php echo isset($pasien->sex) ? $pasien->sex : ''; ?></td>
                    </tr>
                    <tr>
                        <td class="col-sm-3">Tempat Tanggal Lahir</td><td>:</td>
                        <td>
                            <?php
                    ...
                    <tr>
                        <td class="col-sm-3">Umur</td><td>:</td>
                    ...
                    <tr>
                        <td class="col-sm-3">Penanggung Jawab</td><td>:</td>
